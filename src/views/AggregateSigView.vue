<template>
  <div class="flex flex-auto space-x-6">
    <div class="flex-auto">
      <label for="signatureA" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">🖋️ Signature</label>
      <div class="relative">
    ...
    <div class="flex-auto">
      <label for="signatureB" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">🖋️ Signature</label>
      <div class="relative">
