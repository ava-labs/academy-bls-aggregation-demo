<template>
  ...
  <div class="flex flex-col space-y-3 mb-5 relative">
    ...
    <div class="relative">
      ...
      <button
        class="text-white absolute right-2.5 top-2.5 bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-md px-4 py-2"
